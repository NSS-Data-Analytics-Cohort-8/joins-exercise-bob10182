...
SELECT p1.movie_id, p1.film_title,p1.mpaa_rating,p2.distributor_id,p2.company_name,p3.worldwide_gross
FROM specs AS p1
...
GROUP BY p1.movie_id,p1.film_title,p2.distributor_id,p2.company_name,p1.mpaa_rating,p3.worldwide_gross
